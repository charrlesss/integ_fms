...
<script>
        ...
        const sidebarConfig = [
            {
                link:"<?php echo "$url/admin/core-1/" ?>",
                title:"dashboard",
            ...
            },
            {
                ...
                dropdown:[
                    {
                        link:"<?php echo "$url/admin/core-1/booking/fillup-form.php" ?>",
                        title:"Fill-up Form",
                    ...
                    {
                        link:"<?php echo "$url/admin/core-1/booking/reservation-list.php" ?>",
            ...
            },
            {
                ...
                dropdown:[
                    {
                        link:"<?php echo "$url/admin/core-1/Purchase-order-management/order-list.php" ?>",
                        title:"Order List",
                        icon:`<svg class="h-5 w-5 "  fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16m-7 6h7"/>
                        </svg>`
                    ...
                    {
                        link:"<?php echo "$url/admin/core-1/Purchase-order-management/Monitor-purchase.php" ?>",
            ...
            },
            {
                ...
                dropdown:[
                    {
                        link:"<?php echo "$url/admin/core-1/Bill-of-Lading/delivery-view.php" ?>",
                        title:"Delivery View",
                        icon:`<svg class="h-5 w-5 "  fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16m-7 6h7"/>
                        </svg>`
            ...
            },
            {
                ...
                dropdown:[
                    {
                        link:"<?php echo "$url/admin/core-1/Consolidation-&-Decon/view-performance.php" ?>",
            ...
            },
            {
                ...
                dropdown:[
                    {
                        link:"<?php echo "$url/admin/core-1/Shipment-file/record-shipment.php" ?>",
