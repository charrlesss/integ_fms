            ...
            $.ajax({
                ...
                success:function(res){
                  ...
                  const dateInput = `${date.toLocaleDateString('fr-CA', { year: 'numeric', month: '2-digit', day: '2-digit' })}`
                    const id =res.visitor.visitors_account_id
                    $.ajax({
                      url:"<?php echo $url?>" + "/controller/administrative/visitor-management.php/getTimeinVisitorByQrCode/" + id +"/"+dateInput+"/"+timein,
                      type:"GET",
