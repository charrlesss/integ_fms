      ...
      <div class="bg-indigo-50 flex-grow  ">
          ...
          <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                <h1 class="text-3xl text-black pb-6">Account Receivable</h1>
                ...
                <div class="w-full ">
                    <p class="text-xl pb-3 flex items-center">
                        <i class="fas fa-list mr-3"></i> Receivable Ledger
                    </p>
                    <div class="bg-white overflow-auto">
                        <table class="min-w-full bg-white">
                            ...
                            <div class="flex flex-row w-full bg-gray-100 h-16  text-black ">
                                <div class="w-2/6 ">
                                    <div class="text-left text-lg   uppercase my-4 px-2">Current Date: 02/14/23</div>
                                </div>
                                <div class="w-28 px-2 py-2">Total Receivable:</div>
                                <div class="max-w-full px-2 py-5 bg-gray-200 text-red-500">₱ 13,450.00</div>
                                <div class="w-1/3 bg-gray-200"></div>
                            </div>

                            <thead class="bg-purple-300 text-white">
                                <tr>
                                    <th class="w-1/12 text-left py-2 px-3 uppercase font-semibold text-sm border-r-2 border-gray-100">Invoice Date</th>
                                    <th class="w-1/12 text-left py-2 px-3 uppercase font-semibold text-sm border-r-2 border-gray-100">Invoice Number</th>
                                    <th class="w-1/12 text-left py-2 px-3 uppercase font-semibold text-sm border-r-2 border-gray-100">Customer</th>
                            ...
                            <tbody class="text-gray-700">
                                <tr class=" bg-gray-100">
                                    ...
                                    <td class=" text-center border-r-2 border-gray-100">A1102</td>
                                    <td class=" text-center border-r-2 border-gray-100">Customer 1</td>
                                    <td class=" text-center border-r-2 border-gray-100">₱ 20,000.00 </td>
                                    <td class=" text-center border-r-2 border-gray-100">02/29/2023</td>
                                    <td class=" text-center border-r-2 border-gray-100">₱ 13,000.00</td>
                                    <td class=" text-center border-r-2 border-gray-100"></td>
                                    <td class=" text-center border-r-2 border-gray-100">₱ 1,500.00</td>
                                    <td class=" text-center border-r-2 border-gray-100"></td>
                                    <td class=" text-center border-r-2 border-gray-100">₱ 1,000.00</td>
                                    <td class=" text-center border-r-2 border-gray-100"></td>
                                    <td class=" text-center border-r-2 border-gray-100">₱ -</td>
                                </tr>

                                <tr class=" bg-gray-200">
                                    <td class=" text-center py-2 px-3 border-r-2 border-gray-100">01/10/2024</td>
                                    <td class=" text-center border-r-2 border-gray-100">B2300</td>
                                    <td class=" text-center border-r-2 border-gray-100">Customer 2</td>
                                    <td class=" text-center border-r-2 border-gray-100">₱ 1,000.00 </td>
                                    <td class=" text-center border-r-2 border-gray-100">11/24/2024</td>
                                    <td class=" text-center border-r-2 border-gray-100">₱ 450.00</td>
                                    <td class=" text-center border-r-2 border-gray-100"></td>
                                    <td class=" text-center border-r-2 border-gray-100">₱ 150.00</td>
                                    <td class=" text-center border-r-2 border-gray-100"></td>
                                    <td class=" text-center border-r-2 border-gray-100">₱ 200.00</td>
                                    <td class=" text-center border-r-2 border-gray-100"></td>
                                    <td class=" text-center border-r-2 border-gray-100">₱ -</td>
                                </tr>
