      ...
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            <li class="mr-3">
              <a class="inline-block py-2 px-4 lg:text-white font-bold no-underline md:hover:text-gray-100 hover:text-underline py-2 px-4" href="<?php echo '/fms'?>">Home</a>
            </li>
            <li class="mr-3">
              <a class="inline-block lg:text-white no-underline md:hover:text-gray-100 hover:text-gray-400 hover:text-underline py-2 px-4" href="<?php echo "/fms/visitor.php"?>">Visitor</a>
            </li>
            <li class="mr-3">
              <a class="inline-block lg:text-white no-underline md:hover:text-gray-100 hover:text-gray-400 hover:text-underline py-2 px-4" href="<?php echo "/fms/admin"?>">Employeer</a>
            </li>
            <li class="mr-3">
              <a  class="inline-block lg:text-white no-underline md:hover:text-gray-100 hover:text-gray-400 hover:text-underline py-2 px-4"  href="<?php echo "/fms/contact-us.php"?>">Contact us</a>
            </li>
          </ul>
        </div>
      </div>
            ...
            const data = JSON.parse(res)
                 if(data.success){
                   return Swal.fire({
                    ...
                    window.location.href = "<?php echo $url."/admin/financial-admin/" ?>"
                  })
                 }
              Swal.fire({
                icon: 'error',
