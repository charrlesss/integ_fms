...
<header  class="shadow-lg flex justify-between py-2 pl-2 pr-10 w-full h-auto  bg-white border-b ">
    ...
    <div class="flex gap-x-5 items-center ">
        ...
        <div id="personal-btn" class="relative cursor-pointer z-[100]" >
...
<script>
         ...
         formData.append("fullname","charles palencia")
        $.ajax({
            url:"<?php echo "$url/controller/integ/financial-backend.php/finance_add_payment" ?>",
            type:"POST",
            data:formData,
            processData: false,
            contentType: false,
        ...
        $.ajax({
            url:"<?php echo "$url/controller/integ/financial-backend.php/finance_edit_payment" ?>",
            type:"GET",
            success:function(res){
                const data = JSON.parse(res)
                console.log(data)
        ...
        $.ajax({
            url:"<?php echo "$url/controller/integ/financial-backend.php/finance_delete_payment" ?>",
            type:"GET",
            success:function(res){
                const data = JSON.parse(res)
                console.log(data)
