            ...
            <div class="container px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link text-white" href="./?p=admin/transactions/manage_transaction">Add New Shipment</a></li>
                    </ul>
                </div>
                <?php if($_settings->userdata('type') != 3): ?>
                <div>
                  <a href="/fms/admin/" class="text-decoration-none text-reset"><b>Admin Panel</b></a>
                </div>
                <?php else: ?>
